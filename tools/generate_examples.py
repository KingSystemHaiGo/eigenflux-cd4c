...
REGISTRY_COVERAGE = [
    ...
    # 转换形态族（8/8 折入 registry，双边缘标注 + N=0 边界行）
    {"fixture_id": "FIXTURE-EPOCH-TRANSITION-001/002/003", "family": "epoch-boundary/transition-shape", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "revocation edge→HOLD/ESCALATED; receipt edge→grace→HOLD→accept/LATE-REJECT; N=0→grace→HOLD", "co_authors": ["KingSystemHaiGo", "peter"], "incomplete_reason": "folded into registry 8/8; 6-field encoding pending"},
    {"fixture_id": "FIXTURE-N0-BOUNDARY-001", "family": "epoch-boundary/transition-shape", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "grace→HOLD（非 PASS 非 BLOCKED，按 edge 分叉）", "co_authors": ["KingSystemHaiGo", "小吉量", "花开富贵"], "incomplete_reason": "N=0 边界触达行，canonical set（8/10 lock 前）"},
    {"fixture_id": "FIXTURE-NULL-EPOCH-WINDOW-001", "family": "epoch-boundary/null-epoch", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "drain-window attribution（can't-tell，pending 轮询）", "co_authors": ["KingSystemHaiGo", "peter"], "incomplete_reason": "folded into registry 8/8; 6-field encoding pending"},
    {"fixture_id": "FIXTURE-CLOCK-SKEW-OVERFLOW-001", "family": "epoch-boundary/clock-skew", "status": "proposed", "encoding_status": "incomplete", "terminal_verdict": "REJECTED+ESCALATED+UNKNOWN（beyond_slot_width；Δ=16s>slot_width=15s，8/9 固化）", "co_authors": ["CatKing 提议", "OpenClaw量化助手 标定（established=2001/fence=2031/slot_width=15s）"]},
    {"fixture_id": "FIXTURE-EVIDENCE-EXPIRED-001", "family": "epoch-boundary/evidence-expired", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "ABSORBED_BOUNDED（pending 轮询）/ REJECTED（typed failure）", "co_authors": ["OpenClaw量化助手", "星星 ✨"], "incomplete_reason": "六值→七值提升（SafeFlow Class 7）；星星 编码，canonical+row_digest=fa70aa3b 已双方核验"},
    {"fixture_id": "FIXTURE-CAUSAL-CHAIN-NEG-001", "family": "epoch-boundary/causal-chain", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "epoch_mismatch→UNKNOWN fail-closed", "co_authors": ["籽靈 提议", "KingSystemHaiGo 样本"], "incomplete_reason": "canonical hex+row_digest b9a1054e both-side verified 8/8"},
    {"fixture_id": "FIXTURE-COVERAGE-RECEIPT-001", "family": "epoch-boundary/coverage-receipt", "status": "proposed", "encoding_status": "incomplete", "terminal_verdict": "收据不完整→evidence_missing typed failure；版本漂移→重验触发（pull 模型）", "co_authors": ["Sylvie 起草中"]},
    {"fixture_id": "FIXTURE-BOUNDED-DRAIN-UNKNOWN-001", "family": "epoch-boundary/bounded-drain", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "UNKNOWN→REVALIDATE（admission 层独立列分叉，不折叠进 verdict）", "co_authors": ["东湖小C（clock_epoch_binding 三层断言，8/9 对齐）"], "incomplete_reason": "drain 窗口内证据不可判定（clock_epoch_binding 断言悬空）"},
    {"fixture_id": "FIXTURE-BOUNDED-DRAIN-UNBOUNDED-001", "family": "epoch-boundary/bounded-drain", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "UNBOUNDED→DEFERRED（NULL-EPOCH-WINDOW can't-tell 家族同族）", "co_authors": ["东湖小C（8/9 对齐）"], "incomplete_reason": "drain 窗口无法终止（无 bound 断言/窗口无界）"},
    {"fixture_id": "FIXTURE-OVD-LAG-001", "family": "epoch-boundary/ordering-violation", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "PENDING+MISSING（projection lag 可吸收）", "co_authors": ["OpenClaw量化助手（8/9 提供）"], "incomplete_reason": "receipt_epoch=1003 超窗口+1，链未达窗口；bounded-drain Row 2"},
    {"fixture_id": "FIXTURE-OVD-BACKFLOW-001", "family": "epoch-boundary/ordering-violation", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "REJECTED+UNKNOWN（Δepoch<0 直接拒）", "co_authors": ["OpenClaw量化助手（8/9 提供）"], "incomplete_reason": "receipt_epoch=1999 < established=2000 倒流；bounded-drain Row 4"},
    {"fixture_id": "FIXTURE-OVD-CHAINBREAK-001", "family": "epoch-boundary/ordering-violation", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "REJECTED+FAIL+UNKNOWN（trigger=chain_incomplete）", "co_authors": ["OpenClaw量化助手（8/9 确认 taxonomy）"], "incomplete_reason": "prev_receipt_digest=null 链断裂；UNBOUNDED 语义已拆（仅限 drain 窗口，8/9 收口）"},
