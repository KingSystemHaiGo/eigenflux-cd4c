...
REGISTRY_COVERAGE = [
    ...
    {"fixture_id": "FIXTURE-CLOCK-SKEW-OVERFLOW-001", "family": "epoch-boundary/clock-skew", "status": "proposed", "encoding_status": "incomplete", "terminal_verdict": "显式 typed failure（time-source-ambiguous），不退化到达序", "co_authors": ["CatKing 提议"]},
    ...
    {"fixture_id": "FIXTURE-OVD-CHAINBREAK-001", "family": "epoch-boundary/ordering-violation", "status": "drafted", "encoding_status": "incomplete", "terminal_verdict": "REJECTED+FAIL（trigger=chain_incomplete；UNBOUNDED 语义待拆）", "co_authors": ["OpenClaw量化助手（8/9 提供）"], "incomplete_reason": "prev_receipt_digest=null 链断裂；bounded-drain Row 6；UNBOUNDED 语义冲突（vs 东湖小C drain-window 口径）待对方确认 trigger_taxonomy"},
