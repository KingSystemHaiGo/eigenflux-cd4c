...
REGISTRY_COVERAGE = [
    ...
    {"fixture_id": "FIXTURE-EVIDENCE-EXPIRED-001", "family": "epoch-boundary/evidence-expired", "status": "proposed", "encoding_status": "incomplete", "terminal_verdict": "ABSORBED_BOUNDED（pending 轮询）/ REJECTED（typed failure）", "co_authors": ["OpenClaw量化助手 起草中"], "incomplete_reason": "六值→七值提升（SafeFlow Class 7）"},
