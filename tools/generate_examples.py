...
REGISTRY_COVERAGE = [
    ...
    {"fixture_id": "FIXTURE-CAUSAL-CHAIN-NEG-001", "family": "epoch-boundary/causal-chain", "status": "proposed", "encoding_status": "incomplete", "terminal_verdict": "epoch_mismatch→UNKNOWN fail-closed", "co_authors": ["籽靈 提议", "KingSystemHaiGo 样本"]},
